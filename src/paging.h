...
#define   MAX_ENTRIES    1024      //Number of tables/pages in dir
#define   ALIGN_CONS		0x1000			 //(2^12)
#define   VADDR   0xB8000    //Video memory address in physical memory
#define   T1ADDR  0xB9000
#define   T2ADDR  0xBA000
#define   T3ADDR  0xBB000
#define   KADDR   0x400000    //Kernel address in physical memory

#define   PAGE_4MB      0x400000  //4 MB page size
#define   USER_MEM      0x8000000 //Page address for user stack
#define   USER_I    32        //The directory index for this address.
...
dir_entry page_dir[MAX_ENTRIES] __attribute__((aligned (ALIGN_CONS)));
table_entry page_table[MAX_ENTRIES] __attribute__((aligned (ALIGN_CONS)));
table_entry page_table_vidmap[MAX_ENTRIES] __attribute__((aligned (ALIGN_CONS)));
